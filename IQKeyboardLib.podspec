#
#  Be sure to run `pod spec lint IQKeyboardLib.podspec' to ensure this is a
...
12345567890
  ...
  s.homepage     = "https://github.com/appledev201888/IQKeyboardLib"
  ...
  s.source       = { :git => "https://github.com/appledev201888/IQKeyboardLib.git", :tag => "#{s.version}" }
